...
export function About() {
  ...
  return (
    <section id="about" className="bg-[#F5F3EF] py-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <motion.h2 
              ...
              className="text-xs tracking-wide mb-12 opacity-60"
            >
            ...
            <motion.h3
              ...
              className="text-5xl tracking-tight mb-12 leading-tight"
            >
              We create spaces that make sense.
            </motion.h3>

            <div className="space-y-6 text-base leading-relaxed mb-10">
              <motion.p
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 text-white">
              ...
              <div className="text-2xl">Excellence in Design</div>
            </div>
          </motion.div>
        </div>
      </div>
