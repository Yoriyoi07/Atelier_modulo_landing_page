      ...
      <div className="max-w-[1600px] mx-auto px-8 lg:px-12 xl:px-16">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
            ...
            >
              <h2 className="text-6xl tracking-tight leading-tight mb-6">
                FEATURED PROJECTS
              </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <div className="aspect-[4/3] overflow-hidden mb-6 bg-neutral-100 rounded-sm shadow-lg group-hover:shadow-2xl transition-shadow duration-500 relative">
                <motion.div
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-all duration-500 flex items-center justify-center">
                    <motion.div
                      ...
                      className="text-white text-sm tracking-widest opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                    >
                      VIEW PROJECT
                    </motion.div>
                  </div>
                ...
                {/* Badge */}
                <div className="absolute top-4 right-4 bg-white px-4 py-2 rounded-full text-xs tracking-wider shadow-lg">
                  {project.category}
                </div>
              </div>
              <motion.div 
              ...
              >
                <div className="flex-1">
                  <h3 className="mb-2 text-xl group-hover:translate-x-2 transition-transform duration-300">{project.title}</h3>
                ...
                <motion.div
                  ...
                  className="flex-shrink-0 w-10 h-10 rounded-full border-2 border-black/20 flex items-center justify-center group-hover:bg-black group-hover:border-black transition-all duration-300"
                >
                  <div className="w-4 h-4 border-r-2 border-t-2 border-black group-hover:border-white rotate-45 transition-colors duration-300" />
                </motion.div>
              </motion.div>
            </motion.div>
          ))}
