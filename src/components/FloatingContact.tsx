  ...
  return (
    <div className="fixed bottom-8 right-8 z-50">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-20 right-0 bg-white rounded-lg shadow-2xl p-4 w-64 border border-black/10"
          >
            <div className="text-sm mb-4">Quick Contact</div>
      ...
      <motion.button
        ...
        className="w-16 h-16 rounded-full bg-black text-white shadow-2xl flex items-center justify-center hover:bg-black/90 transition-colors"
      >
