      ...
      <div className="max-w-[1600px] mx-auto px-8 lg:px-12 xl:px-16">
        <div className="mb-16">
          ...
          <motion.h2 
            ...
            className="text-5xl tracking-tight max-w-2xl leading-tight"
          >
            OUR PROCESS
          </motion.h2>
          <motion.p 
            ...
            className="mt-6 text-sm opacity-70 max-w-xl"
          >
          ...
          {steps.map((step, index) => {
            ...
            return (
              <motion.div 
                ...
                whileHover={{ y: -8 }}
                className="bg-white border-2 border-black/5 p-8 rounded-sm hover:border-black/20 hover:shadow-xl transition-all duration-300 relative overflow-hidden group"
              >
                {/* Background number */}
                <div className="absolute top-4 right-4 text-[8rem] leading-none opacity-[0.03] select-none transition-all duration-300 group-hover:opacity-[0.06]">
                  {step.number}
                </div>
                ...
                <div className="relative">
                  <motion.div 
                    ...
                    className="mb-6"
                  >
                    <div className="w-16 h-16 rounded-full bg-black/5 flex items-center justify-center group-hover:bg-black group-hover:scale-110 transition-all duration-300">
        ...
        <motion.div 
          ...
          className="text-center mt-20 text-sm opacity-70"
        >
